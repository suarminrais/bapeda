        ...
        <div class="row">
            <div class="col-sm-8">
                <ol type="I">
                    ...
                    <li>Kesimpulan</li>
                    <h6>Permohonan mutasi seluruhnya diteruskan ke Sub Bidang  Pengolahan Data  untuk diproses lebih lanjut. <br> <center>Demikian disampaikan untuk dapat dipergunakan seperlunya.</h6>
                </ol>
            </div>
        </div>
        <div class="row">
