        ...
        <div class="row">
            <div class="col-sm-8">
                <ol type="I">
                    ...
                    <li>Kesimpulan</li>
                    <h6>Permohonan mutasi penggabungan {{$data->jumlah}} OP diteruskan ke Sub Bidang  Pengolahan Data   untuk diproses lebih lanjut. </h6>
                </ol>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-sm-8 ttd">
                ...
                <h6 style="margin-left: 5%; float: left;">Kapala Sub Bidang Pendataan dan Pendaftaran <br>
