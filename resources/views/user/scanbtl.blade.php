	      ...
	      <div class="x_content">
	        ...
	        <div class="row">
		        ...
		        <div class="col-md-4 col-sm-4 col-xs-12">
					<form action="{{route('postStatusBetul', $data->id)}}" method="POST">@method('PUT') @csrf 
	        ...
	        <br>
	        <form method="POST" action="{{route('scanUploadbtl',$data->id)}}" enctype="multipart/form-data" class="dropzone" id="my-dropzone">
	        	@csrf
