	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
	    <div class="x_panel">
	      ...
	      <div class="x_content">
	        <br />
	        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('postdatabaru') }}">
	        @csrf
	          <div class="form-group">
	            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pemohon">Pemohon :  <span class="required">*</span>
	            </label>
	            <div class="col-md-6 col-sm-6 col-xs-12">
	              <input type="text" name="pemohon" required="required" class="form-control col-md-7 col-xs-12">
	            </div>
	          </div>
	          <div class="form-group">
	          ...
	          <div class="form-group">
	            ...
	            <div class="col-md-6 col-sm-6 col-xs-12">
	              <input type="text" id="tanggal" name="tanggal" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo date('d F Y')?>">
	            </div>
	          </div>
	          <div class="form-group">
	            <label for="notetangga" class="control-label col-md-3 col-sm-3 col-xs-12">NOP Tetangga : <span class="required">*</span></label>
	            <div class="col-md-6 col-sm-6 col-xs-12">
	              <input id="notetangga" value="73-02-" required="required" class="form-control col-md-7 col-xs-12" type="text" name="notetangga">
	            </div>
	          </div>
	          <div class="form-group">
